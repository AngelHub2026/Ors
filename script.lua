...
local hubTitleLbl = New("TextLabel", {
    Text = "ORKSZ DUELS", TextColor3 = Color3.fromRGB(230, 50, 50),
...
task.spawn(function()
    ...
    holdDot.Text = "◉"; holdDot.ZIndex = 12
    ...
    holdGear.Text = "⚙"; holdGear.AutoButtonColor = false; holdGear.ZIndex = 13
...
do
    ...
    local autoLoadEnabled = (togglesState["autoLoadKick"] == true) or (getgenv and getgenv().ORS_AUTOLOAD == true) or false
    local kickConn = nil
